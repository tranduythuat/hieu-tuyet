...
<head>
    ...
    <meta property="og:title" content="<?php echo empty($title) ? 'Ngọc Hiếu & Ánh Tuyết' : 'Ngọc Hiếu & Ánh Tuyết | ' . htmlspecialchars($title); ?>">
    <meta property="og:description" content="21.12.2025" />
    ...
    <title>Ngọc Hiếu & Ánh Tuyết</title>
</head>
...
<body>
        ...
        <div class="container-wrapper">
            <div class="box-top" data-aos="flip-left">
                <div class="box-contop">
                    ...
                    <label for="" data-aos="fade-up" class="lb-top3">Ngọc Hiếu & Ánh Tuyết</label>
                </div>
            </div>
            ...
            <div class="info nha-gai">
                ...
                <div class="inv">
                    ...
                    <label for="" class="lb-inv">Ngọc Hiếu & Ánh Tuyết</label>

                    <!-- <img src="https://pub-d341ea7ec201435598469d75d8c4a056.r2.dev/nhi-phuong/DAT_4853_02.webp" alt="" class="img-inv"> -->
                    <div class="img-inv">
                        <img src="https://pub-d341ea7ec201435598469d75d8c4a056.r2.dev/tuyet-hieu/5cdd87364661c93f90708.webp"
                            alt="" class="">
                    </div>

                    <div class="time-add">
                        <!-- <p class="nhatrai">Nhà Gái</p> -->
                        <label for="" class="lb-time">VÀO <strong>10:30</strong>, NGÀY<strong>
                                21.12.2025</strong></label>
                        <!-- <label for="" class="lb-time">(ngày 17 tháng 10 năm Ất Tỵ)</label> -->
                        <label for="" class="lb-add location-name" blank>Trung tâm tiệc cưới - sự kiện <br> Nhật
                            Minh</label>
                    </div>

                    <div class="box-map">
                        <p for="" class="add2">Số 25, phố Nguyễn Đình Tương, khu Lâm Thao, xã Lâm Thao, tỉnh Phú Thọ</p>
                        <!-- <label for="" class="add2">/No. 21/4, Khu Pho Trung, Binh Hoa Ward, Ho Chi Minh City, Vietnam/</label> -->
                        <a target="_blank" href="https://maps.app.goo.gl/9ALRB5mmWrhRaqMP8" class="maps">XEM BẢN ĐỒ</a>
                    </div>
                    <!-- <hr> -->
                    <!-- <div class="time-add">
            ...
            <div class="box-image1">
                <div class="img1">
                    <img src="https://pub-d341ea7ec201435598469d75d8c4a056.r2.dev/tuyet-hieu/7095db691a3e9560cc2f7.webp"
                        alt="" class="">
                </div>
                <div class="img2">
                    <img src="https://pub-d341ea7ec201435598469d75d8c4a056.r2.dev/tuyet-hieu/b0217bdaba8d35d36c9c6.webp"
                        alt="" class="">
                </div>
            </div>
            ...
            <div class="container-slide">
                <div class="slider">
                    <div class="slide">
                        <img src="https://pub-d341ea7ec201435598469d75d8c4a056.r2.dev/tuyet-hieu/77efd00111569e08c7479.webp"
                            alt="" style="object-position: 60% 50%;">
                    </div>
                    <div class="slide">
                        <img src="https://pub-d341ea7ec201435598469d75d8c4a056.r2.dev/tuyet-hieu/548c3494f4c37b9d22d21.webp"
                            alt="">
                    </div>
                    <div class="slide">
                        <img src="https://pub-d341ea7ec201435598469d75d8c4a056.r2.dev/tuyet-hieu/05827c97bcc0339e6ad14.webp"
                            alt="">
                    </div>
                    <div class="slide">
                        <img src="https://pub-d341ea7ec201435598469d75d8c4a056.r2.dev/tuyet-hieu/f234af2d6f7ae024b96b2.webp"
                            alt="" style="object-position: 40% 50%;">
                    </div>
                    <div class="slide">
                        <img src="https://pub-d341ea7ec201435598469d75d8c4a056.r2.dev/tuyet-hieu/15127247293910265153.jpg"
                            alt="">
                    </div>
                    <div class="slide">
                        <img src="https://pub-d341ea7ec201435598469d75d8c4a056.r2.dev/tuyet-hieu/15127247293910265152.jpg"
                            alt="" style="object-position: 66% 50%;">
                    </div>
            ...
            <form action="" name="form-nha-trai">
                <div class="logo">
                    <div class="box-flow">
                        <img src="../anh/flower01.png" alt="" class="">
                    </div>
                ...
                <div class="feed-info">
                    ...
                    <label for="" class="in-fe">KHÁCH MỜI VUI LÒNG XÁC NHẬN THAM DỰ<strong> TRƯỚC NGÀY
                            14.12.2025</strong>
                        <br>
                ...
                <div class="box-ten">
                    <input required class="inp-ten" type="text" id="name" name="NAME" placeholder="Tên khách mời">
                    <input required class="inp-ten" type="text" name="GUEST" placeholder="Số Người Đi Kèm" maxlength="1"
                ...
                <div class="box-ten">
                    <textarea id="loi-chuc" name="WISH" rows="6" cols="50"
                        placeholder="HÃY GỬI LỜI CHÚC ĐẾN CÔ DÂU VÀ CHÚ RỂ NHÉ"></textarea>
                </div>
                <div class="wrapper">
    ...
    <script>
        const scripConfirmtURL = 'https://script.google.com/macros/s/AKfycbz2_aDlV9MlR7uGNBGj_DNFohtpahSZZWxC6lp3yDsGgcmNJAz3q69JR3LQJQpexjRz/exec?sheet=nha-trai';
        const form = document.forms['form-nha-trai'];
